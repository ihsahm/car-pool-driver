...
class MyWidget extends StatefulWidget {
  ...
  const MyWidget({Key? key, required this.trip});
}
...
class _MyWidgetState extends State<MyWidget> {
  ...
  double _costPerMinute = 2.0; // 0.5 birr minute
  ...
  void _startTrackingSimulation() {
    ...
    Future.wait(futures).then((_) {
      ...
      firestore
          ...
          .set({
            'passengerIDs':
                passengerIDs // specify the name of the array field and the list of passenger IDs
          })
    ...
    _simulationTimer =
      ...
      if (_lastPosition != null && _destination != null) {
        ...
        double speed = 100; // 5 meters per second
            ...
            child: Column(
              ...
              children: [
                ...
                if (_destination != null)
                  Text(
                    'Total time taken: ${_startTime != null ? DateTime.now().difference(_startTime!).inMinutes : 0} min',
                  ),
              ],
            ),
          ),
